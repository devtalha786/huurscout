  ...
  return (
    ...
    >
      <div className="max-w-full sm:px-[31px] xl:p-0 xl:max-w-[1118px] w-full mx-auto text-black">
        <div className="grid grid-cols-12 flex-wrap py-[50px] items-center">
          <div className="col-span-12 md:col-span-5 p-4">
            <div className="md:max-w-[553px] max-w-[326px] mx-auto md:mx-0 w-full  md:pb-0 ">
              ...
              <p className=" md:max-w-full max-w-[299px] poppins-medium text-[14px] leading-[19.6px] text-[#1A1A1A] py-[30px]">
              ...
              <p className=" md:max-w-full max-w-[299px] poppins-medium text-[14px] leading-[19.6px] text-[#1A1A1A] ">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          ...
          <div className="col-span-12 md:col-span-7 p-4  ">
            <div>
              <Image
                ...
                alt=" "
              />
              <p className="poppins md:max-w-full max-w-[243px] font-normal pt-[15px] pb-[30px] text-[12px] leading-[16.8px] text-[#1A1A1A] ">
