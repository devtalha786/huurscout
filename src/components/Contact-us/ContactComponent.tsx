          ...
          <div className="col-span-12 md:col-span-6  p-4">
            <div className="mx-4 md:mx-0">
              <div className="flex flex-col gap-3">
                <h1 className="poppins font-bold text-[12px] leading-[16.8px] text-[#1A1A1A]">
                  Kom maar op
                </h1>
                <p className="poppins font-medium text-[14px] leading-[19.6px] text-[#1A1A1A] max-w-[296px] w-full">
                  Kom maar door met je bericht. We reageren gewoonlijk binnen 24
                  uur. Kom maar door met je bericht. We reageren gewoonlijk
                  binnen 24 uur.
                </p>
                <div
                ...
                >
                  <Image
                    src="/assets/images/image 257.svg"
                    height={32}
                    width={32}
                    alt="whats app"
                  />
                ...
                >
                  <Image
                    src="/assets/images/image 258.svg"
                    height={32}
                    width={32}
                    alt="whats app"
                  />
                ...
                >
                  <Image
                    src="/assets/images/Google_Maps_icon_(2020) 1.svg"
                    height={39}
                    width={27}
                    alt="whats app"
                  />
